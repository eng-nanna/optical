...
class Users {
	...
	function __construct(){
		...
		$dbUsername = 'optical'; //Define database username
		$dbPassword = 'optical'; //Define database password
		$dbName = 'optical'; //Define database name
	...
	function checkUser($oauth_provider,$oauth_uid,$fname,$lname,$email,$gender,$locale,$picture){
		...
		$ins_user = mysqli_query($this->connect,"INSERT INTO users (f_name,l_name,gender,mail,status_en,status_ar) 
							  VALUES ('$fname','$lname','$gender','$email','new member','عضو جديد')");
