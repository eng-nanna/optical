...
if (isset($_POST['submit'])){
	...
	$query = mysqli_query($db_conn,"INSERT INTO users (f_name,l_name,gender,mail,password,tel,area,street,building,status_en,status_ar) 
							  VALUES ('$f_name','$l_name','$gender','$mail','$pass','$tel','$area','$street','$building','new member','عضو جديد')");
	if ($query){
		$_SESSION['user'] = $mail;
		$queries=mysqli_query($db_conn, "SELECT * FROM cart WHERE user_id = '$guest_id'");
		$sqls = mysqli_query($db_conn,"SELECT * FROM users WHERE mail = '$mail'");
		$row2 = mysqli_fetch_array($sqls);
		while ($row1 = mysqli_fetch_array($queries)){
			$user_id = $row2['id'];
			$sql1 = mysqli_query($db_conn,"INSERT INTO cart (user_id,type,glass_id,quantity) 
						VALUES ('$user_id','registered','$row1[glass_id]','$row1[quantity]')");
		}
		$results= mysqli_query($db_conn, "DELETE FROM cart WHERE user_id='$guest_id'");
            ...
            <div class="large-5 column large-wings">
			  ...
			  if (isset($_SESSION['user'])){
                ...
                <ul class="menu vertical">
                  <li><a href="#"><i class="fa fa-gears"></i> My account</a></li>
					...
					if (isset($_SESSION['user'])){
                        ...
                        <div class="cart-item">
                          ...
                          <div>
                            ...
                            <div class="price"><?php echo $item['price']." EGP"; ?></div>
                            <a href="del_temp.php?id=<?php echo $id; ?>">
                        ...
                        <a href="#" class="button expanded">Checkout</a>
                      </div><!-- cart-content -->
                        <?php
		  }else{
						?>
      ...
      -->
        ...
        <div class="row align-center">
          <div class="small-12 medium-5 column">
            <section class="signup innerPadding">
              ...
              <form action="" method="post" data-abide novalidate>
                <div data-abide-error class="alert callout" style="display: none;">
                 ...
                 <label>
                  Email *
                  <input type="email" name="mail" value="<?php if (isset($_GET['user'])){ echo $mail; } ?>" required>
                  <span class="form-error">
                ...
                <input type="submit" class="button large radius expanded" name="submit" value="Signup">
